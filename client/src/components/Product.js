...
export default function Product() {
  ...
  useEffect(() => {
    const fetchGuitar = async () => {
      ...
      if (user) {
        ...
        const script = document.createElement("script"); //esta creando un elemento, un script,

        script.type = "text/javascript"; //le confiugura una ruta
        script.src = "https://sdk.mercadopago.com/js/v2";

        script.addEventListener("load", () => {
          addCheckout(id);
        }); //va a estar escuchando que se resuelva este evento
        return document.body.appendChild(script); //agrega el botón
      }
    };
  ...
  const addCheckout = (id) => {
    const mp = new window.MercadoPago(
      "TEST-d33be377-3036-4442-93a0-3c1fd6dfb913",
      {
        locale: "es-MX",
      }
    );
                ...
                <div className="mt-10">
                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      <li className="text-gray-400">
                        <span className="text-gray-600">Feature II</span>
                      </li>

                      <li className="text-gray-400">
                        <span className="text-gray-600">Feature III</span>
                      </li>

                      <li className="text-gray-400">
                        <span className="text-gray-600">Feature IV</span>
                      </li>
                    </ul>
                  </div>
                </div>
